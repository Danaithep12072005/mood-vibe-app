...
class _AiChatPageState extends State<AiChatPage> {
  ...
  void initState() {
    ...
    const apiKey = 'AIzaSyC7HK2fQo0FFhtp4ESXlLTALC-phezeuaY';
    ...
    if (!_isInitialMessageSent) {
      ...
      if (args != null) {
        ...
        if (topic.isNotEmpty || detail.isNotEmpty) {
          ...
          if (topic.isNotEmpty && detail.isNotEmpty) {
            prompt =
                'วันนี้ฉันรู้สึกไม่ค่อยโอเคเรื่อง: "$topic"\nรายละเอียดคือ: $detail';
  ...
  Future<void> _sendMessage({String? autoMessage}) async {
    ...
    try {
      ...
      String detectedTag = '';
      if (aiText.contains('[SAD]')) {
        detectedTag = 'SAD';
      } else if (aiText.contains('[STRESS]')) {
        detectedTag = 'STRESS';
      } else if (aiText.contains('[CHILL]')) {
        detectedTag = 'CHILL';
      } else if (aiText.contains('[HAPPY]')) {
        detectedTag = 'HAPPY';
      }
      ...
      if (mounted) {
        setState(() {
          ...
          messages.add({
            'sender': 'ai',
            'text':
                'ขออภัยครับ ตอนนี้ผมกำลังเชื่อมต่อระบบไม่ได้ ลองตรวจสอบอินเทอร์เน็ตดูนะครับ',
            'hasMusic': false,
            'musicTag': '',
          });
        });
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: msg['sender'] == 'user'
                      ...
                      : _buildAiMessageWithMusic(
                          msg['text'],
                          showMusic: msg['hasMusic'] ?? false,
  ...
  Widget _buildUserMessage(String text) {
    return Row(
      ...
      children: [
        ...
        CircleAvatar(
          radius: 18,
          backgroundColor: moodVibeDarkBrown.withValues(alpha: 0.8),
  ...
  Widget _buildAiMessageWithMusic(
    String text, {
    ...
    Map<String, Map<String, String>> uiDisplayData = {
      ...
      'CHILL': {
        ...
        'image':
            'https://images.unsplash.com/photo-1529156069898-49953eb1b5ae?w=500',
      },
      'HAPPY': {
        'title': 'Mood Booster (สดใส)',
        'image':
            'https://images.unsplash.com/photo-1534152815023-e6ebecf5eb9f?w=500',
      },
    };

    final displayInfo =
        uiDisplayData[musicTag] ??
        {
          'title': 'เพลงโปรดของคุณ',
          'image':
              'https://images.unsplash.com/photo-1493225457284-0bf53ce815fc?w=500',
        };
    ...
    return Row(
      ...
      children: [
        CircleAvatar(
          ...
          child: Icon(
            Icons.spa,
            color: moodVibeDarkBrown.withValues(alpha: 0.5),
            size: 20,
          ),
        ),
        const SizedBox(width: 10),
            ...
            child: Column(
              ...
              children: [
                ...
                if (showMusic) ...[
                  ...
                  GestureDetector(
                    onTap: () async {
                      // 📍 1. โชว์ข้อความว่ากำลังโหลด
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('กำลังเข้าสู่โหมดทดสอบ...'),
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => MusicPlayerPage(
                              trackName: '${displayInfo['title']} (ทดสอบ)',
                              artistName: 'AI Recommend',
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: NetworkImage(displayInfo['image']!),
                          fit: BoxFit.cover,
                        ),
                        boxShadow: [
                          BoxShadow(
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              const Text(
                'AI กำลังประมวลผล...',
                style: TextStyle(color: moodVibeDarkBrown, fontSize: 13),
              ),
              ...
              Row(
                children: [
                  Container(
                    width: 4, height: 4,
                    decoration: const BoxDecoration(color: moodVibeAccent, shape: BoxShape.circle),
                  ),
