            ...
            children: [
              Row(
                children: [
                  ...
                  const Text(
                    'บันทึกสาเหตุอารมณ์',
                    style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: moodVibeDarkBrown),
                  ),
                ],
              ),
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintStyle: TextStyle(color: moodVibeDarkBrown.withOpacity(0.4)),
                ...
                children: List.generate(moods.length, (index) {
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      height: 55,
                      decoration: BoxDecoration(
                        color: isSelected ? moods[index]['color'].withOpacity(0.3) : Colors.transparent,
                        shape: BoxShape.circle,
                      ),
                      child: Center(
                        child: Icon(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.white,
                  borderRadius: BorderRadius.circular(20),
                  border: Border.all(color: moodVibeDarkBrown.withOpacity(0.3)),
                ),
                child: Stack(
                  children: [
                    TextField(
                    ...
                    Positioned(
                      bottom: 15,
                      right: 15,
                      child: Icon(Icons.post_add, color: moodVibeDarkBrown.withOpacity(0.5)),
                    ),
                  ],
                ),
              ),
              ...
              ElevatedButton(
                onPressed: () async {
                  try {
                    ...
                    if (context.mounted) {
                      // 📍 1. ส่งข้อความแนบไปกับ Navigator ด้วย
                      Navigator.pushNamed(
                        context, 
                        '/ai_chat',
                        arguments: {
